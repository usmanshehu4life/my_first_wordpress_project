 ...
 * Instructor 
 */
add_action( 'learn-press/before-courses-loop-item', 'online_educenter_instructor' , 1010 );
if(!function_exists('online_educenter_instructor')){
    function online_educenter_instructor (){
